...
/**
 * Generates a safe HTML offer file for client-side rendering.
 * Don't use in server-side contexts as it relies on DOMPurify which is client-only.
 * @param OfferFileTemplateProps - The properties of the offer file, including content and metadata.
 * @returns HTML Offer File as a string, sanitized for safe rendering in the browser.
 */
export const generateSafeOfferHTMLClient = ({

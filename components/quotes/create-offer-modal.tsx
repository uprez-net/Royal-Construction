...
import { List, Loader2, Plus, Upload } from "lucide-react";
          ...
          {leadSearch.loading ? (
            <div className="grid gap-3 sm:grid-cols-2">
              {Array.from({ length: 10 }).map((_, i) => (
                <div
                  key={i}
                  className="animate-pulse rounded-2xl border border-border bg-background p-4 max-h-[50vh] no-scrollbar overflow-y-auto"
                >
            ...
            <div className="grid gap-3 sm:grid-cols-2 max-h-[50vh] no-scrollbar overflow-y-auto">

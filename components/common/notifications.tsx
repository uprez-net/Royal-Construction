...
import { EmptyState, InboxLoading, UnreadDot } from "../notification/util-components";
  ...
  return (
    <Popover open={notificationsOpen} onOpenChange={setNotificationsOpen}>
      ...
      <PopoverContent
        align="end"
        sideOffset={12}
        className="w-96 overflow-hidden rounded-2xl border border-white/10 bg-[oklch(0.16_0.03_249.8)] p-0 text-slate-100 shadow-[0_24px_60px_rgba(15,23,42,0.28)]"
      >
